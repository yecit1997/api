...
options = [["N/A", "N/A"], ["Femenino", "Femenino"], ["Masculino", "Masculino"]]
...
class User(models.Model):
    ...
    sex = models.CharField(max_length=100, choices=options, verbose_name="Sexo")
    civil_status = models.CharField(max_length=100, choices=option_civil_status)
...
class Product(models.Model):
    ...
    desciption = models.CharField(max_length=255, default="", blank=True, null=True)
...
class SaleOn(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    creation_date = models.DateTimeField(
        auto_now_add=True, verbose_name="Tiempo de creación"
    )
